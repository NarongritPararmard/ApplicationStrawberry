      ...
      body: Column(
        ...
        children: [
            ...
            child: Stack(
              ...
              children: [
                Container(
                  ...
                  height: 450,
                  child: Image.asset(
                    'assets/picture/Screenshot 2567-10-22 at 22.17.33.png', // เพิ่มพาธรูปภาพที่นี่
                    // fit: BoxFit.cover,
                  ),
                ),
          ...
          Container(
            ...
            child: Container(
              margin:
                  EdgeInsets.only(left: 28.0), // กำหนดระยะห่างจากขอบซ้าย 20 px
              ...
              child: Center(
                // จัดตำแหน่งให้เนื้อหากลาง
                child: Text(
                  '''นี่คือสายพันธุ์ของสตรอว์เบอร์รีของคุณ!            ''',
                  style: TextStyle(
                    color: Color.fromARGB(255, 35, 41, 45),
                    fontSize: 18,
                    fontFamily: "Prompt",
