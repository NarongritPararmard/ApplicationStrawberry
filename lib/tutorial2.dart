...
import 'package:myapplication/tutorial3.dart';
      ...
      body: Column(
        ...
        children: [
            ...
            child: Stack(
              ...
              children: [
                Container(
                  ...
                  height: 450,
                  child: Image.asset(
                    'assets/picture/Screenshot 2567-10-22 at 22.17.24.png', // เพิ่มพาธรูปภาพที่นี่
                    // fit: BoxFit.cover,
                  ),
                ),
          ...
          Container(
            ...
            child: Container(
              margin:
                  EdgeInsets.only(left: 22.0), // กำหนดระยะห่างจากขอบซ้าย 20 px
              width: 200, // กำหนดความกว้างของ Container
              height: 50, // กำหนดความสูงของ Container
              decoration: BoxDecoration(
                // color: const Color.fromARGB(
                //     255, 239, 87, 89), // สีพื้นหลังของ Container
                color: Colors.white,
          ...
          Container(
            ...
            child: Container(
              ...
              height: 25, // กำหนดความสูงของ Container
              decoration: BoxDecoration(
                // color: const Color.fromARGB(
                //     255, 239, 87, 89), // สีพื้นหลังของ Container
                color: Colors.white,
              ...
              child: Center(
                // จัดตำแหน่งให้เนื้อหากลาง
                child: Text(
                  '''ระบบกำลังวิเคราะห์ภาพ กรุณารอสักครู่...       ''',
                  style: TextStyle(
                    color: Color.fromARGB(255, 35, 41, 45),
                    fontSize: 18,
                    fontFamily: "Prompt",
